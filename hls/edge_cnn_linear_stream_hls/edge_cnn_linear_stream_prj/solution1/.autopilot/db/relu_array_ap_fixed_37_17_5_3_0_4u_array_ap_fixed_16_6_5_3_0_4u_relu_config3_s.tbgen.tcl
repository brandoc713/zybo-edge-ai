set moduleName relu_array_ap_fixed_37_17_5_3_0_4u_array_ap_fixed_16_6_5_3_0_4u_relu_config3_s
set isTopModule 0
...
set C_modelName {relu<array<ap_fixed<37, 17, 5, 3, 0>, 4u>, array<ap_fixed<16, 6, 5, 3, 0>, 4u>, relu_config3>}
set C_modelType { void 0 }
set C_modelArgList {
	{ layer2_out int 148 regular {fifo 0 volatile }  }
	{ layer3_out int 64 regular {fifo 1 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "layer2_out", "interface" : "fifo", "bitwidth" : 148, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ layer2_out_dout sc_in sc_lv 148 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer2_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":148, "type": "signal", "bundle":{"name": "layer2_out", "role": "dout" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "layer2_out", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "19602", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "layer2_out_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "layer3_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "19602", "DependentChanType" : "0",
				"BlockSignal" : [
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "19605", "Max" : "19605"}
	, {"Name" : "Interval", "Min" : "19605", "Max" : "19605"}
]}
...
set Spec2ImplPortList { 
	layer2_out { ap_fifo {  { layer2_out_dout fifo_data 0 148 }  { layer2_out_empty_n fifo_status 0 1 }  { layer2_out_read fifo_update 1 1 } } }
	layer3_out { ap_fifo {  { layer3_out_din fifo_data 1 64 }  { layer3_out_full_n fifo_status 0 1 }  { layer3_out_write fifo_update 1 1 } } }
}
