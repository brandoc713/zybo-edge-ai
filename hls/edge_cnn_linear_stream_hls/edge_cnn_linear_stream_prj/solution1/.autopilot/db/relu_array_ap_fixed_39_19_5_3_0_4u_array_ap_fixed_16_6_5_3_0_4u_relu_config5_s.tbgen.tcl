set moduleName relu_array_ap_fixed_39_19_5_3_0_4u_array_ap_fixed_16_6_5_3_0_4u_relu_config5_s
set isTopModule 0
...
set C_modelName {relu<array<ap_fixed<39, 19, 5, 3, 0>, 4u>, array<ap_fixed<16, 6, 5, 3, 0>, 4u>, relu_config5>}
set C_modelType { void 0 }
set C_modelArgList {
	{ layer4_out int 156 regular {fifo 0 volatile }  }
	{ layer5_out int 64 regular {fifo 1 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "layer4_out", "interface" : "fifo", "bitwidth" : 156, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ layer4_out_dout sc_in sc_lv 156 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer4_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":156, "type": "signal", "bundle":{"name": "layer4_out", "role": "dout" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "layer4_out", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "19602", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "layer4_out_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "layer5_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "19602", "DependentChanType" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	layer4_out { ap_fifo {  { layer4_out_dout fifo_data 0 156 }  { layer4_out_empty_n fifo_status 0 1 }  { layer4_out_read fifo_update 1 1 } } }
	layer5_out { ap_fifo {  { layer5_out_din fifo_data 1 64 }  { layer5_out_full_n fifo_status 0 1 }  { layer5_out_write fifo_update 1 1 } } }
}
