...
// zp2d_conv1_2filters
struct config5 : nnet::padding2d_config {
...
struct config2_mult : nnet::dense_config {
    ...
    typedef conv1_2filters_accum_t accum_t;
    typedef bias2_t bias_t;
    typedef conv1_2filters_weight_t weight_t;
...
struct relu_config3 : nnet::activ_config {
    static const unsigned n_in = 39204;
    static const unsigned table_size = 1024;
    static const unsigned io_type = nnet::io_stream;
    static const unsigned reuse_factor = 64;
    typedef conv1_2filters_relu_table_t table_t;
};

// zp2d_conv2_output_logits
struct config6 : nnet::padding2d_config {
    static const unsigned in_height = 121;
    static const unsigned in_width = 162;
...
struct config4_mult : nnet::dense_config {
    ...
    static const unsigned n_zeros = 0;
    static const unsigned multiplier_limit = DIV_ROUNDUP(n_in * n_out, reuse_factor) - n_zeros / reuse_factor;
    typedef conv2_output_logits_accum_t accum_t;
    typedef bias4_t bias_t;
    typedef conv2_output_logits_weight_t weight_t;
    template<class data_T, class res_T, class CONFIG_T>
