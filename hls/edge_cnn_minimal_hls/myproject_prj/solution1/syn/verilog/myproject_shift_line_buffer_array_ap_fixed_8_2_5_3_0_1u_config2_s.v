...
reg    void_conv_2d_buffer_cl_stream_stream_weight_t_bias_t_line_buffer_0_1_ce0;
reg    void_conv_2d_buffer_cl_stream_stream_weight_t_bias_t_line_buffer_0_1_we0;
wire   [7:0] void_conv_2d_buffer_cl_stream_stream_weight_t_bias_t_line_buffer_0_1_q0;
reg    void_conv_2d_buffer_cl_stream_stream_weight_t_bias_t_line_buffer_2_ce0;
reg    void_conv_2d_buffer_cl_stream_stream_weight_t_bias_t_line_buffer_2_we0;
wire   [7:0] void_conv_2d_buffer_cl_stream_stream_weight_t_bias_t_line_buffer_2_q0;
reg   [0:0] ap_NS_fsm;
...
myproject_shift_line_buffer_array_ap_fixed_8_2_5_3_0_1u_config2_s_void_conv_2d_buffer_cbkb #(
    ...
    .AddressRange( 164 ),
    .AddressWidth( 8 ))
void_conv_2d_buffer_cl_stream_stream_weight_t_bias_t_line_buffer_0_1_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .address0(8'd163),
...
always @ (*) begin
    if (((ap_start == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        void_conv_2d_buffer_cl_stream_stream_weight_t_bias_t_line_buffer_0_1_ce0 = 1'd1;
    end else begin
        void_conv_2d_buffer_cl_stream_stream_weight_t_bias_t_line_buffer_0_1_ce0 = 1'b0;
    end
end

always @ (*) begin
    if (((ap_start == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        void_conv_2d_buffer_cl_stream_stream_weight_t_bias_t_line_buffer_0_1_we0 = 1'd1;
    end else begin
        void_conv_2d_buffer_cl_stream_stream_weight_t_bias_t_line_buffer_0_1_we0 = 1'b0;
    end
end

always @ (*) begin
    if (((ap_start == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        void_conv_2d_buffer_cl_stream_stream_weight_t_bias_t_line_buffer_2_ce0 = 1'd1;
    end else begin
        void_conv_2d_buffer_cl_stream_stream_weight_t_bias_t_line_buffer_2_ce0 = 1'b0;
    end
end

always @ (*) begin
    if (((ap_start == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        void_conv_2d_buffer_cl_stream_stream_weight_t_bias_t_line_buffer_2_we0 = 1'd1;
    end else begin
        void_conv_2d_buffer_cl_stream_stream_weight_t_bias_t_line_buffer_2_we0 = 1'b0;
    end
end
