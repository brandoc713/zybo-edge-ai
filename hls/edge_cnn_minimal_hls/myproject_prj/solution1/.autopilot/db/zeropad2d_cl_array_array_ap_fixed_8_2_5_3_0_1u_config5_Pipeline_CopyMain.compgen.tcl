...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { input_image_TVALID { I 1 bit } input_image_TDATA { I 8 vector } input_image_TREADY { O 1 bit } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { layer5_out_din { O 8 vector } layer5_out_full_n { I 1 bit } layer5_out_write { O 1 bit } } \
} "
}
