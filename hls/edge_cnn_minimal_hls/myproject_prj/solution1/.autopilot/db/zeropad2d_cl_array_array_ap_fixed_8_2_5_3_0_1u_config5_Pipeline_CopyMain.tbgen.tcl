set moduleName zeropad2d_cl_array_array_ap_fixed_8_2_5_3_0_1u_config5_Pipeline_CopyMain
set isTopModule 0
...
set C_modelName {zeropad2d_cl<array,array<ap_fixed<8,2,5,3,0>,1u>,config5>_Pipeline_CopyMain}
...
set Spec2ImplPortList { 
	input_image { axis {  { input_image_TVALID in_vld 0 1 }  { input_image_TDATA in_data 0 8 }  { input_image_TREADY in_acc 1 1 } } }
