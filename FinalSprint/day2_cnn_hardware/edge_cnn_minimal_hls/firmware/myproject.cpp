...
void myproject(
    ...
    nnet::conv_2d_cl<layer5_t, layer2_t, config2>(layer5_out, layer2_out, w2, b2); // conv1_2filters

    nnet::relu<layer2_t, layer3_t, relu_config3>(layer2_out, layer3_out); // conv1_2filters_relu
